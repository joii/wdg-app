...
return new class extends Migration
{
    ...
    {
        Schema::create('pawn_sub100nm_data', function (Blueprint $table) {
            $table->id();
            ...
            $table->boolean('is_erased')->nullable()->default(0)->comment('Is_Erased');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('pawn_sub100nm_data');
    }
};
