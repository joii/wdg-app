                                ...
                                <table class="table align-middle datatable dt-responsive table-check nowrap" style="border-collapse: collapse; border-spacing: 0 8px; width: 100%;">
                                    <thead>
                                        <tr class="bg-transparent">
                                                ...
                                                <th>เลขที่สัญญาหลัก</th>
                                                <th>รหัสบาร์โค้ดหลัก</th>
                                                <th>สินค้า</th>
                                                <th>ยอดอนุมัติ</th>
                                                <th>ยอดที่เพิ่มได้</th>
                                                <th>ลูกค้า</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $item->total_pawn_amount-$item->total_pawn_amount_first }}</td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li><a class="dropdown-item" href="{{ route('backend.pawn_transaction.contract',$item->id) }}" target="_blank">หนังสือสัญญาหลัก</a></li>
                                                        <li><a class="dropdown-item" href="{{ route('backend.pawn_add.pawn_add_list',$item->pawn_barcode) }}" target="_blank">รายการเพิ่มต้น</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
