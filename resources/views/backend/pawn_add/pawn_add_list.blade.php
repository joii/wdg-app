                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle datatable dt-responsive table-check nowrap" style="border-collapse: collapse; border-spacing: 0 8px; width: 100%;">
                                    ...
                                    <tbody>
                                        @foreach ($pawn_add_data as $item)
                                        <tr>
                                            <td>{{ $item->pawn_id }}</td>
                                            <td>{{ $item->pawn_barcode }}</td>
                                            <td>{{ \Carbon\Carbon::parse($item->pawn_date_cal_interest)->thaidate('j F Y') }}</td>
                                            <td>{{ \Carbon\Carbon::parse($item->pawn_expire_date)->thaidate('j F Y') }}</td>
                                            <td>{{ $item->period }}</td>
                                            <td>{{ $item->pawn_add }}</td>
                                            <td>
                                                <div class="dropdown">
