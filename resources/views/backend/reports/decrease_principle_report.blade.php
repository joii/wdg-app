        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">รายงานรายการลดเงินต้น</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">ภาพรวม</a></li>
                            <li class="breadcrumb-item active">รายงานรายการลดเงินต้น</li>
                        </ol>
                    </div>
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">สรุปยอดเงินรายการลดเงินต้น</h4>
                    </div>
                    <div class="card-body">
                        <div id="column_chart" data-colors='["#ffbf00"]' class="apex-charts" dir="ltr"></div>
                    </div>
                </div><!--end card-->
            </div>
             <div class="col-xl-6">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">จำนวนการทำธุรกรรมรายการลดเงินต้น</h4>
                    </div>
                    <div class="card-body">
                        <div id="column_chart2" data-colors='["#ffbf00"]' class="apex-charts" dir="ltr"></div>
                    </div>
                </div><!--end card-->
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="card-title">รายการลดเงินต้น<br>
                            <p class="card-title-desc">รายการลดเงินต้น {{ \Carbon\Carbon::parse($startOfLastWeek)->thaidate('j F Y') }} ถึงวันที่ {{ \Carbon\Carbon::parse($endOfLastWeek)->thaidate('j F Y') }}
                            </p>
                        </h4>
