            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">สรุปภาพรวมรายการดอกเบี้ยค้างชำระปี {{ now()->year+543 }}</h4>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="card-title">รายการดอกเบี้ยค้างชำระ<br>
                            <p class="card-title-desc">รายการดอกเบี้ยค้างชำระถึงวันที่ {{ now()->day }} {{ config('constants.month_th')[now()->month-1] }} {{ now()->year + 543 }} เวลา {{ now()->format('H:i') }}
                            </p>
                        </h4>
