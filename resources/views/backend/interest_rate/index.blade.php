                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header" style="text-align: right;">
                                      <a href="{{ route('backend.interest_rate.create') }}" class="btn btn-success" >เพิ่มข้อมูล</a>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                            ...
                                            <tr>
                                                ...
                                                <th><a href="{{ route('backend.interest_rate.edit',$item->id) }}" class="btn btn-outline-danger">แก้ไข</a></th>
                                            </tr>
                                            @endforeach
