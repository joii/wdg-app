        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="myForm" action="{{ route('backend.interest_rate.update') }}" method="post" >
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    <div>
                                ...
                                <div class="col-lg-12">
                                    <div>
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" type="text" name="interest_rate"  id="interest_rate" value="{{ $data->interest_rate }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
