        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="myForm" action="{{ route('backend.facebook_pixel.update') }}" method="post" >
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    <div>
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" type="text" name="pixel_name"  id="pixel_name" required value="{{ $data->pixel_name }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div>
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" type="text" name="pixel_id"  id="pixel_id" required value="{{ $data->pixel_id }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div>
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" type="text" name="domain_scope"  id="domain_scope" placeholder="all" required value="{{ $data->domain_scope }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div>
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" type="text" name="event_script"  id="event_script" value="{{ $data->event_script }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-4">
                                ...
                                <a href="{{ route('backend.facebook_pixel.destroy',$data->id) }}" onclick="return confirm('ยืนยันการลบข้อมูล')" class="btn btn-danger waves-effect waves-light">ลบข้อมูล</a>
                        </div>
                            </form>
                    </div>
