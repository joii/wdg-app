        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">รายละเอียดรายการต่อดอก</h4>
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">รายละเอียดรายการต่อดอก</li>
                        </ol>
                    </div>
                        ...
                        <div class="card-body">
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-shrink-0">
                                        <div class="mb-4">
                                            ...
                                            <h4 class="float-end font-size-16"> <input class="form-control" type="text" name="pawn_id"  id="pawn_id" value="68{{  isset($data->pawn_id)?$data->pawn_id:null }}" disabled></h4>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <div >
                                        <label for="pawn_card_no" class="form-label form-edit">เลขที่บัตร:</label>
