        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                     <h4 class="mb-sm-0 font-size-18">รายการเพิ่มเงินต้น</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">ภาพรวม</a></li>
                            <li class="breadcrumb-item active">รายการเพิ่มเงินต้น</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div>
                            ...
                            <strong>วันที่เพิ่มยอด:</strong> {{ \Carbon\Carbon::parse($transaction_data->transaction_date)->thaidate('j F Y') }}<br/>
                            <strong>จำนวนเงินที่เพิ่ม:</strong>{{ number_format($transaction_data->payment_amount) }} บาท<br/>
