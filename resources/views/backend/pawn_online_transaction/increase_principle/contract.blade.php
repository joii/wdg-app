        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">หนังสือสัญญาเพิ่มเงินต้น</h4>
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">หนังสือสัญญาเพิ่มเงินต้น</li>
                        </ol>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <!-- end card -->
                     @else
                      <p>ไม่พบข้อมูลหนังสือสัญญาเพิ่มเงินต้น</p>
                     @endif
