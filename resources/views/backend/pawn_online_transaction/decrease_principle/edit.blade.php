        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">รายละเอียดรายการลดเงินต้น</h4>
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">รายละเอียดรายการลดเงินต้น</li>
                        </ol>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('backend.online_transaction.increase_principle.update') }}" method="POST">
                            @csrf
                                ...
                                <div class="col-sm-6 mb-4">
                                    ...
                                    <h5 class="font-size-15">รายละเอียดสัญญา:</h5>
                                        ...
                                        <div>
                                          ...
                                          <div>
                                            <label  class="form-label form-edit">รายการส่งดอก</label>
                                            <p>
                                                <a href="{{ route('backend.online_transaction.accrued_interest.contract',$transaction_data->pawn_barcode) }}">คู่สัญญาส่งดอก</a>
                                            </p>
