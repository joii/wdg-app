            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p>092 979 7777</p>
                        <div>
                            <strong>เลขที่บัตร:</strong> {{ $data->pawn_card_no==null?'-':$data->pawn_card_no }}</br>
                            <strong>เลขที่บาร์โค้ด:</strong>{{ $data->pawn_barcode }}</br>
                            <strong>วันที่ส่งดอก:</strong> {{ \Carbon\Carbon::parse($transaction_data->transaction_date)->thaidate('j F Y') }}<br/>
                            <strong>จำนวนเงิน(ดอกเบี้ย):</strong>{{ number_format($transaction_data->payment_amount) }} บาท<br/>
                            <strong>ส่งเงินต้น:</strong> 0 บาท<br/>
                            <strong>ไถ่ถอน:</strong> 0 บาท<br/>
                            <hr/>
                            <strong>รวมเก็บเงิน:</strong>{{ number_format($transaction_data->payment_amount) }} บาท<br/>
                            <hr/>
                    ...
                    <div class="col-sm-12">
                        <div>
                            <strong>ครบกำหนด</strong><br/>
                             {{ \Carbon\Carbon::parse($transaction_data->transaction_date)->addDays(60)->thaidate('j F Y') }}</br>
