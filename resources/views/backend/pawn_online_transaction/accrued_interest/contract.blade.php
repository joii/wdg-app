        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">หนังสือสัญญาส่งดอก</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">ภาพรวม</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('backend.online_transaction.accrued_interest_list') }}">รายการขายฝาก</a></li>
                            <li class="breadcrumb-item active">หนังสือสัญญาขายฝากส่งดอก</li>
                        </ol>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div>
                                        <h5 class="font-size-15">วันที่ทำสัญญา/วันที่ฝาก:</h5>
                                        <p>
                                    ...
                                    <div>
                                        <div>
                                            ...
                                            <p>
                                                ...
                                                <hr/>
                                                <strong>เงินต้น:</strong>  {{ number_format($transaction_parties_data->payment_amount) }} บาท<br/>
                                                <strong>ชำระดอกเบี้ยค้างจ่าย:</strong>{{ number_format($transaction_data->payment_amount) }} บาท<br/>
