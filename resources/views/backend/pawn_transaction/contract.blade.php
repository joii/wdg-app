        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">หนังสือสัญญาขายฝาก</h4>
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">หนังสือสัญญาขายฝาก</li>
                        </ol>
                    </div>
                            ...
                            <div class="invoice-title mt-4">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-shrink-0">
                                        <div class="mb-4">
                                            <h4 class="float-end font-size-16">สัญญาเลขที่ {{ \Carbon\Carbon::parse($data->pawn_date)->thaidate('y') }}{{sprintf('%05d', $data->pawn_id) }}</h4>
                                        </div>
                                    </div>
                                </div>
