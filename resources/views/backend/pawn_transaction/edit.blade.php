        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('backend.pawn_transaction.update') }}" method="POST">
                            @csrf
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-shrink-0">
                                        <div class="mb-4">
                                            ...
                                            <h4 class="float-end font-size-16"> <input class="form-control" type="text" name="pawn_id"  id="pawn_id" value="68{{  $data->pawn_id }}" disabled></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 mb-4">
                                    ...
                                    <h5 class="font-size-15">รายละเอียดสัญญา:</h5>
                                        ...
                                        <div>
                                            ...
                                            <input class="form-control" type="text" name="remarks"  id="remarks" value="{{ $data->remarks }}" disabled >
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            <label for="percent_interest" class="form-label form-edit">อัตราดอกเบี้ย:</label>
                                            <input class="form-control" type="text" name="percent_interest"  id="percent_interest" value="{{ $data->percent_interest }}" disabled >
                                        </div>
