        ...
        <div class="container">
             <div class="card">
                <div class="boxed" style="--width:370px">
                    ...
                    <div class="row gy-3">
                        <form action="{{ route('customer.outstanding-interest.payment.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="col-12">
                            ...
                            สัญญาเลขที่: {{ (Str::substr($year, 2, 2))  }}{{ $pawn_data->pawn_id }}
                                ...
                                <p>{{ number_format($pawn_send_data->interest) }} บาท</p>
                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <table class="table-data">
                    ...
                    <tr>
                        <th>ยอดชำระ</th>
                        <td><span class="fw-600" style="color: #007B5C;">{{ number_format($pawn_send_data->interest) }}</span> บาท</td>
                    </tr>
                </table>
