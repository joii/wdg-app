               ...
               <div class="boxed" style="--width:500px">
                    <div class="d-block py-md-2 mt-md-2">
                     ...
                     <div class="row gy-4 form">
                        ...
                        <form method="POST" action="{{ route('customer.pay_decrease_principle') }}">
                            @csrf
                            <div class="col-12">
                                <div class="card card-border p-3 p-sm-4">
                                    ...
                                    <table class="table-data">
                                        ...
                                        <tr>
                                            <th>ยอดที่ต้องการลดต้น :</th>
                                            <td>
                                            {{ number_format($add_amount) }} บาท
                                            </td>
                                        </tr>
                                        <tr>
                                         ...
                                         <tr>
                                            ...
                                            <td>
                                            {{ number_format($add_amount+$pawn_send_data->interest) }} บาท
                                            </td>
                                        </tr>
                             ...
                             <div class="col-12 py-sm-4 mb-sm-5">
                                ...
                                <input type="submit" class="btn btn-green-dark w-100 mx-auto" style="max-width:370px" value="ชำระเงิน">
